...
#myFolds <- createDataPartition(json_features_all_pcaps_df$avg_entropy, times = 10, p = 0.9, list = FALSE)    # The class probability and distribution got skewed here
myFolds <- createDataPartition(json_features_all_pcaps_df$proto_label, times = 10, p = 0.9)   # The class probability distributions in the folds were better here
#myFolds
head(myFolds)
