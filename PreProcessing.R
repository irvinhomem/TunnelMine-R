...
train_ctrl <- trainControl(method = "repeatedcv", number = 10, p=0.9, repeats = 5, savePredictions = "final", returnResamp = "final", returnData = TRUE) # classProbs = TRUE # sampling = "none"
