...
#svm.model <- train(frmla, data=json_features_all_pcaps_df, method = "svmLinear", trControl=train_ctrl)
#svm.model <- train(frmla, data=json_features_all_pcaps_df, method = "lssvmLinear", trControl=train_ctrl)

svm_model <- train(frmla, data=json_features_all_pcaps_df, method = "svmLinear2", trControl=train_ctrl)
